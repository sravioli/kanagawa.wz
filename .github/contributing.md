# kanagawa.wz Contributing Guide

Welcome to the kanagawa.wz contributing guide, and thank you for your interest.

We accept the following types of contributions:

- **Source code** — bug fixes, new features, and improvements to the color
  scheme modules or public API. See [Environment setup](#environment-setup),
  [Best practices](#best-practices), and [Contribution
...
kanagawa.wz is a [Kanagawa](https://github.com/rebelot/kanagawa.nvim)-inspired
color scheme plugin for [WezTerm](https://wezfurlong.org/wezterm/). It ships
three variants (wave, dragon, lotus) and a helper API for selecting, customizing,
and applying them. See the [README](readme.md) for full usage details.
...
1. Check existing [issues](https://github.com/sravioli/kanagawa.wz/issues) to avoid
   duplicates.
...
2. Clone your fork:
   ...
   ```sh
   git clone https://github.com/<your-username>/kanagawa.wz.git
   cd kanagawa.wz
   ```
...
Include your OS, WezTerm version, kanagawa.wz version or commit, relevant
...
2. Open a pull request against `main` on
   [sravioli/kanagawa.wz](https://github.com/sravioli/kanagawa.wz).
